    ...
    <v-card flat>
        ...
        <v-tabs-items v-model="tab">
            <v-tab-item key="percentage">      
                <v-card class="padding">
                    <v-text-field :name="this.$t('Set a gains percentage')" v-model.number="percentage" :counter="10" :label="this.$t('Set a gains percentage')" :placeholder="this.$t('Enter an amount')" :rules="RulesFloatRequired(10)" autofocus></v-text-field>
                </v-card>
            </v-tab-item>
            <v-tab-item key="gain">     
                <v-card class="padding">
                    <v-text-field :name="this.$t('Set a gain')" v-model.number="gains" :counter="10" :label="this.$t('Set a gain')" :placeholder="this.$t('Enter an amount')" :rules="RulesFloatRequired(10)"></v-text-field>
                </v-card>
            </v-tab-item>
            <v-tab-item key="price">     
                <v-card class="padding">
                    <v-text-field :name="this.$t('Set a price')" v-model.number="price" :counter="10" :label="this.$t('Set a price')" :placeholder="this.$t('Enter an amount')" :rules="RulesFloatRequired(10)"></v-text-field>
                </v-card>
            </v-tab-item>
        </v-tabs-items>         
        <v-form ref="form" v-model="form_valid" lazy-validation action="url 'investments_same_product_change_selling_price' products_id=product.id)" method="POST">
            <my-datepicker name="selling_expiration" v-model="selling_expiration" label=this.$t('Selling expiration')></my-datepicker> 
