        ...
        <h1>{{ $t("Total report") }}</h1>
            <div class="d-flex justify-center mb-4">
                <v-card width="20%" class="pa-5">
                    ...
                    <v-text-field v-model.number="target"  :label="$t('Set annual gains target')" :placeholder="$t('Set annual gains target')" :rules="RulesFloat(6,true)" counter="6" suffix=" %" autofocus/>
                </v-card>
            </div>
        <div class="pa-6">
