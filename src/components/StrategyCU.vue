    ...
    <div>    
        ...
        <v-card class="pa-8 mt-2">
            <v-form ref="form" v-model="form_valid">
                ...
                <v-text-field :readonly="deleting" density="compact" v-model.number="newstrategy.additional2" v-if="additional_visibility[1]" :label="additional_labels[1]" :placeholder="additional_labels[1]" :rules="RulesInteger(10,false)" counter="10"/>
                ...
                <v-text-field :readonly="deleting" density="compact" v-model.number="newstrategy.additional9" v-if="additional_visibility[8]" :label="additional_labels[8]" :placeholder="additional_labels[8]" :rules="RulesInteger(10,false)" counter="10"/>
                <v-text-field :readonly="deleting" density="compact" v-model.number="newstrategy.additional10" v-if="additional_visibility[9]" :label="additional_labels[9]" :placeholder="additional_labels[9]" :rules="RulesInteger(10,false)" counter="10"/>
            </v-form>
            <v-card-actions>
                <v-spacer></v-spacer>
                <v-btn v-if="!deleting" color="primary" @click="accept()">{{ button() }}</v-btn>
