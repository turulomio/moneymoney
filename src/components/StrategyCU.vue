    ...
    <div>    
        ...
        <v-card class="pa-8 mt-2">
            <v-form ref="form" v-model="form_valid">
                ...
                <v-text-field data-test="StrategyCU_Additional3" :readonly="deleting" density="compact" v-model.number="newstrategy.additional3" v-if="additional_visibility[2]" :label="additional_labels[2]" :placeholder="additional_labels[2]" :rules="RulesInteger(10,false)" counter="10"/>
                ...
                <v-text-field data-test="StrategyCU_Additional5" :readonly="deleting" density="compact" v-model.number="newstrategy.additional5" v-if="additional_visibility[4]" :label="additional_labels[4]" :placeholder="additional_labels[4]" :rules="RulesInteger(10,false)" counter="10"/>
