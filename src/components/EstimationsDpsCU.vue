        ...
        <v-card>
            ...
            <v-form ref="form" v-model="form_valid" lazy-validation v-if='estimation!=null'>
                <v-col>
                    ...
                    <v-text-field v-model="newestimation.estimation" type="text" :label="$t('Estimation')" :counter="10" :placeholder="$t('Enter a estimation')" autofocus @focus="$event.target.select()" :rules="RulesFloat(10, true)"></v-text-field>
                </v-col>
                <v-card-actions>
                    <v-spacer></v-spacer>
