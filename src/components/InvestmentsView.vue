...
<script>
    ...
    import { percentage_string,listobjects_average_ponderated, parseResponseError, currency_string, localcurrency_string, listobjects_sum, myheaders } from '@/functions.js'
