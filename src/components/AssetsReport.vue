    ...
    export default {
        ...
        methods:{
            ...
            async launch_report_alternative(){
                ...
                const docDefinition = {
                    content: [    
                        { image: await convertImageToDataURL(imgMoneymoney), width: 200, alignment: 'center', margin: [0, 100, 0, 0] },
                        { text: 'Assets report', style: 'header', alignment:'center' },
                        ...
                        { text: 'Chapter 1', style: 'header', tocItem: true, tocStyle: { bold: true } },
                        {
                            table: {
                                headerRows: 1,
                                widths: ['*', 'auto', 100, '*'],
