<template>
    <div>
        ...
        <div v-if="alerts">
            ...
            <v-alert class="mx-15 px-10 mb-2" type="success" :key="i" variant="outlined" v-if="(alerts.investments_inactive_with_balance.length + alerts.orders_expired.length + alerts.accounts_inactive_with_balance.length)==0"> 
