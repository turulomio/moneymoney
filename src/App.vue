...
<!--                     ACCOUNTS -->
                    <v-list-item data-test="LateralAccounts" link router :to="{ name: 'accounts_list'}" v-if="store.logged" prepend-icon="mdi-calculator" :title="$t('Accounts')" />
<!--                     INVESTMENTS -->
                    <v-list-item data-test="LateralInvestments" link router :to="{ name: 'investments_list'}" v-if="store.logged" prepend-icon="mdi-finance" :title="$t('Investments')" />
<!--                     ORDERS -->
                    <v-list-item data-test="LateralOrders" link router :to="{ name: 'orders_list'}" v-if="store.logged" prepend-icon="mdi-cart" :title="$t('Orders')" />

<!--                     PRODUCTS -->
                    <v-list-group data-test="LateralProducts" value="Products" v-if="store.logged">
...
<!--                     REPORTS -->
                    <v-list-group data-test="LateralReports" value="Reports" v-if="store.logged">
...
<!--                     STRATEGIES -->
                    <v-list-item  data-test="LateralStrategies" link router :to="{ name: 'strategies_list'}" v-if="store.logged" prepend-icon="mdi-strategy" :title="$t('Strategies')" />
...
<!--                     HELP -->
                    <v-list-group data-test="LateralHelp" value="Help">
                        ...
                        <v-list-item data-test="LateralStatistics" link router :to="{ name: 'statistics'}" :title="$t('Statistics')" v-if="store.logged"/>
        ...
        <v-app-bar color="primary" dark  fixed fill-height app >
            ...
            <v-btn data-test="LateralSettings" :to="{ name: 'settings'}" v-if="store.logged"><v-icon icon="mdi-wrench" dark></v-icon></v-btn> 
            <v-btn data-test="LateralAssetsReport" :to="{ name: 'assetsreport'}" v-if="store.logged"><v-icon icon="mdi-book" dark></v-icon></v-btn>
            <v-spacer />
