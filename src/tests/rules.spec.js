...
test('RulesDateIsoString',() =>{
    ...
    expect (validate_rules("2023-12-12",  RulesDateIsoString(false),   false)).toBe(true)
    expect (validate_rules("2023",  RulesDateIsoString(false),   false)).toBe(false)
    expect (validate_rules("2023-12",  RulesDateIsoString(false),   false)).toBe(false)
    expect (validate_rules("2023-12-32",  RulesDateIsoString(false),   false)).toBe(false)
    expect (validate_rules(2023,  RulesDateIsoString(false),   false)).toBe(false)
    expect (validate_rules(2023.12,  RulesDateIsoString(false),   false)).toBe(false)
    expect (validate_rules("",  RulesDateIsoString(false),   false)).toBe(true)
